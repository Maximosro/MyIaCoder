    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm animate-fade-in">
      ...
      >
        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h3 className="text-[#f0ece8] font-mono text-sm">Unsaved Changes</h3>
            <p className="text-[#8b5a3c] text-[11px] font-mono">{fileName}</p>
          </div>
        </div>
        ...
        <div className="flex gap-2 justify-end">
          ...
          <button
            onClick={onSave}
            className="px-3 py-1.5 text-xs font-mono rounded bg-[#d4784a] text-white hover:bg-[#e8956a] transition-all duration-200"
          >
            Save
          </button>
        </div>
